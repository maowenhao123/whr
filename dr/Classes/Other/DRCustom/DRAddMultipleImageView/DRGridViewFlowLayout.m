...
@interface DRGridViewFlowLayout () <UIGestureRecognizerDelegate>

@property (nonatomic,readonly) id<DRGridViewDataSource> dataSource;
@property (nonatomic,readonly) id<DRGridViewDelegateFlowLayout> delegate;

@end

@implementation DRGridViewFlowLayout
{
...
- (id<DRGridViewDataSource>)dataSource
{
    return (id<DRGridViewDataSource>)self.collectionView.dataSource;
}

- (id<DRGridViewDelegateFlowLayout>)delegate
{
    return (id<DRGridViewDelegateFlowLayout>)self.collectionView.delegate;
}
...
- (void)longPressGestureRecognizerTriggerd:(UILongPressGestureRecognizer *)longPress
{
    switch (longPress.state) {
        ...
        case UIGestureRecognizerStateBegan:
        {
            ...
            DRAddImageCollectionViewCell *sourceCell = (DRAddImageCollectionViewCell *)sourceCollectionViewCell;
