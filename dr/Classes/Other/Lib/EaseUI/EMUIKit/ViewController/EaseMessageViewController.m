...
- (void)inputTextViewDidBeginEditing:(EaseTextView *)inputTextView
{
    if (self.conversation.type == EMConversationTypeChat && self.isTyping) {
        ...
        EMMessage *msg = [[EMMessage alloc] initWithConversationID:self.conversation.conversationId from:from to:self.conversation.conversationId body:body ext:[self getExtDic]];
...
//            avatar = [NSString stringWithFormat: @"%@%@", baseUrl, user.headImg];
//        }
...
//            avatar = [NSString stringWithFormat: @"%@%@", baseUrl, shopModel.storeImg];
//        }
//        nickName = shopModel.storeName;
//
//        if (!DRStringIsEmpty(shopModel.id)) {
//            [ext setObject:shopModel.id forKey:@"storeId"];
//        }
//    }
//
//    //有头像
//    if (!DRStringIsEmpty(avatar)) {
//        [ext setObject:avatar forKey:@"avatar"];
//    }
//
//    //有昵称
//    if (!DRStringIsEmpty(nickName)) {
